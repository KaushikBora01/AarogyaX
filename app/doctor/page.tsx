...
export default function DoctorPortal() {
  ...
  const languages = {
    ...
    hi: {
      title: "डॉक्टर पोर्टल",
      welcome: doctorData ? `स्वागत है, डॉ. ${doctorData.name}` : "AarogyaX में आपका स्वागत है",
      dashboard: "डैशबोर्ड",
      patients: "मरीज़",
      schedule: "कार्यक्रम",
      emergency: "आपातकाल",
    ...
    pa: {
      title: "ਡਾਕਟਰ ਪੋਰਟਲ",
      welcome: doctorData ? `ਜੀ ਆਇਆਂ ਨੂੰ, ਡਾ. ${doctorData.name}` : "AarogyaX ਵਿੱਚ ਤੁਹਾਡਾ ਸਵਾਗਤ ਹੈ",
      dashboard: "ਡੈਸ਼ਬੋਰਡ",
      patients: "ਮਰੀਜ਼",
      schedule: "ਸਮਾਂ-ਸਾਰਣੀ",
      emergency: "ਐਮਰਜੈਂਸੀ",
