...
export default function PatientPortal() {
  ...
  const languages = {
    ...
    hi: {
      title: "मरीज़ पोर्टल",
      welcome: patientData ? `वापस स्वागत है, ${patientData.name}` : "AarogyaX  में आपका स्वागत है",
      dashboard: "डैशबोर्ड",
    ...
    pa: {
      title: "ਮਰੀਜ਼ ਪੋਰਟਲ",
      welcome: patientData ? `ਵਾਪਸ ਜੀ ਆਇਆਂ ਨੂੰ, ${patientData.name}` : "AarogyaX  ਵਿੱਚ ਆਉਣ ਵਾਲੀ ਸੂਚਨਾ",
      dashboard: "ਡੈਸ਼ਬੋਰਡ",
